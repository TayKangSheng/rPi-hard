# Dump Hardening, Kiosk Mode Links

1. [RPI Fullscreen Browser Kiosk: Wired Watershed](https://blogs.wcode.org/2013/09/howto-boot-your-raspberry-pi-into-a-fullscreen-browser-kiosk/)
1. [Linode Hardening](https://www.linode.com/docs/security/securing-your-server/)
1. [RPI Kiosk Screen Tutorial](https://www.danpurdy.co.uk/web-development/raspberry-pi-kiosk-screen-tutorial/)
